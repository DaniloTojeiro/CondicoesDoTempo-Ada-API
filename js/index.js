...
const input = //Especificar que o input é um elemento ou nulo
...
form === null || form === void 0 ? void 0 : form.addEventListener('submit', (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield fetch(`https://api.openweathermap.org/data/2.5/weather?q=${localizacao}&appid=c41246845e62d9a4a0fda468290036d3&lang=pt_br&units=metric`);
